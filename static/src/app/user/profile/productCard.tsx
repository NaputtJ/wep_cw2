      ...
      <Card className="w-full">
        <CardContent>
          <Box className="flex flex-row justify-between items-center overflow-x-scroll">
            <Link to={`/seller/${order.seller_id}`} aria-label="seller name">
            ...
            <Box className="flex gap-4 p-1 items-center">
              ...
              <IconButton onClick={() => setExpanded((bExpand) => !bExpand)} aria-label="expand button">
                {
                  expanded ?
                    <KeyboardArrowUpIcon /> :
                    ...
                    <Box className="flex flex-row justify-between items-center w-full p-2" key={item.key}>
                      ...
                      >
                        ...
                        <Box className="flex flex-col justify-center">
                          <Box className="whitespace-nowrap text-center" aria-label="proudct unit price">
